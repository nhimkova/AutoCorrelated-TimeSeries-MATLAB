...
f_kappa1_0=loglikelihood(kappa);
f_kappa1_1=loglikelihood([kappa(1)+0.00001,kappa(2),kappa(3),kappa(4)]);
f_kappa1_2=loglikelihood([kappa(1)-0.00001,kappa(2),kappa(3),kappa(4)]);
...
f_kappa2_0=loglikelihood(kappa);
f_kappa2_1=loglikelihood([kappa(1),kappa(2)+0.00001,kappa(3),kappa(4)]);
f_kappa2_2=loglikelihood([kappa(1),kappa(2)-0.00001,kappa(3),kappa(4)]);
...
f_mu_0=loglikelihood(kappa);
f_mu_1=loglikelihood([kappa(1),kappa(2),kappa(3)+0.00001,kappa(4)]);
f_mu_2=loglikelihood([kappa(1),kappa(2),kappa(3)-0.00001,kappa(4)]);
...
f_gamma_0=loglikelihood(kappa);
f_gamma_1=loglikelihood([kappa(1),kappa(2),kappa(3),kappa(4)+0.00001]);
f_gamma_2=loglikelihood([kappa(1),kappa(2),kappa(3),kappa(4)-0.00001]);
